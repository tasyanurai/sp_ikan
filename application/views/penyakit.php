              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <div class="buttons">
				          	  <a href="<?php echo base_url('penyakit/form_penyakit') ?>" style="float: right" class="btn btn_5 btn-md btn-info"><i class="fa fa-plus fa-fw"></i>Add penyakit</a>
				            </div>
				            <div class="xs">
					            <br>
				            </div>
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">Kode Penyakit</th>
                          <th scope="col" class="border-0">Nama Penyakit</th>
                      ...
                      <?php 
                        ...
                        foreach ($penyakit as $g):
                          ...
                          <tr>
                            <td><?php echo $no; ?></td>
                            <td style="text-align: center"><?php echo $g['kd_penyakit'] ?></td>
