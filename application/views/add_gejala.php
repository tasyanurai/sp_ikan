          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <h3 class="page-title">Form Tambah Gejala</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <div class="card card-small mb-4">
                  ...
                  <form action="<?=base_url('gejala/add_gejala')?>" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                              <input type="text" class="form-control" id="nama_gejala" name="nama_gejala"placeholder="Inputkan Nama Gejala" value=""> </div>
                        </div>
                        <div class="form-group">
							<div class="col-md-12">
