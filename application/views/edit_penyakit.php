            ...
            <div class="row">
              <div class="col">
                <div class="card card-small mb-4">
                  ...
                  <form  method="post" action="<?=base_url('penyakit/proses_update')?>">
                    <div class="form-group">
                        <label class="page-title" style="float:left"><b> Kode Penyakit </b></label>
                        <div class="col-md-12">
                              <input type="text" class="form-control" id="kd_penyakit" name="kd_penyakit"placeholder="Inputkan Kode Penyakit" required value="<?php echo $data_detail->kd_penyakit?>"> </div>
                        </div>
                        <div class="form-group">
                        <label class="page-title" style="float:left"><b> Nama Penyakit </b></label>
                        <div class="col-md-12">
                              <input type="text" class="form-control" id="nama_penyakit" name="nama_penyakit"placeholder="Inputkan Nama Penyakit" required value="<?php echo $data_detail->nama_penyakit?>"> </div>
                        </div>
                        <label class="page-title" style="float:left"><b> Solusi </b></label>
                        <div class="col-md-12">
                              <input type="text" class="form-control" id="solusi" name="solusi" placeholder="Inputkan Solusi" required value="<?php echo $data_detail->solusi?>"> </div>
                        </div>
                        <div class="form-group">
							<div class="col-md-12">
